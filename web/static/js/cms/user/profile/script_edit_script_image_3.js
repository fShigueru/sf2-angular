function initCrop(image,x,y,scale){
    jQuery('#fos_user_registration_form_image_proporcoes_0_cropStartLeft').val(x);
    jQuery('#fos_user_registration_form_image_proporcoes_0_cropStartTop').val(y);
    jQuery('#fos_user_registration_form_image_proporcoes_0_scale').val(scale);
...
$(function() {
    $('.image-editor').cropit();
    $('.image-editor').cropit('previewSize', {width: 214, height: 214});
